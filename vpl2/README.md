O objetivo desse VPL é praticar os comandos de entrada e saída específicos de C++ (cin, cout) e também a utilização do tipo string. Você não precisa utilizar outros comandos de entrada como o getline.
